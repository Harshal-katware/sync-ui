  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-serif text-gray-800">Today Report</h1>
          <p className="text-gray-800">{today}</p>
        </div>

        <button
          onClick={downloadPDF}
          className="px-4 py-2 bg-linear-to-r from-emerald-500 to-green-500 text-white rounded-lg shadow hover:scale-105 transition"
        >
          Export
        </button>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-gray-200 p-5 rounded-xl shadow-sm hover:shadow-md transition">

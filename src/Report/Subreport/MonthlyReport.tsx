  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg text-sm font-medium transition-all"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div
          className="text-white p-5 rounded-xl shadow"
          style={{
            background:
              "linear-gradient(135deg, #0d4a3a, #1a6b52)"
          }}
        >

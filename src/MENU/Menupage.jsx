                ...
                <tr>
                  {["#", "Item Name", "Price", "Category", "Actions"].map(
                    (h) => (
                      <th
                        key={h}
                        className="px-5 py-3.5 text-left text-[14px] font-medium text-[#b8ac9a] uppercase tracking-[1.8px] whitespace-nowrap"
                      >
                        {h}
                      </th>
                    ),
              ...
              <tbody>
                {filtered.length === 0 ? (
                  ...
                  filtered.map((item, idx) => (
                    <tr
                      key={item.id}
                      className="border-t border-[#f0ebe0] hover:bg-[#faf7f0] transition-colors text-blue-300"
                    >
                      <td className="px-5 py-3.5 text-[#c5b99e] text-[12px]">
                        {idx + 1}
                      </td>
                      <td className="px-5 py-3.5 font-semibold text-[#1a1200] text-[16px]">
                        {item.name}
                      </td>
                      <td
